...
cinder::Color Block::GetColor(int mode_) {
  if (mode_ == 0) {
    ...
    else if (value == 256) {return cinder::Color(0.933, 0.776, 0.654);}
    else if (value == 128) {return cinder::Color(1, 0.645, 0.6546);}
    else if (value == 64) {return cinder::Color(0.862, 0.760, 0.882);}
    else if (value == 32) {return cinder::Color(0.432, 0.534, 0.654);}
    else if (value == 16) {return cinder::Color(0.901, 0.752, 0.913);}
    else if (value == 8) {return cinder::Color(0.656, 0.123, 0.1231);}
    else if (value == 4) {return cinder::Color(0.546, 0.24, 0.546);}
    else if (value == 2) {return cinder::Color(0.342, 0.234, 0.234);}
  }
}
